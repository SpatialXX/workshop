...
############
            if event.key == pygame.K_UP : # si la touche est la fleche droite
                player.sens = "mont" # on déplace le vaisseau de 1 pixel sur la gauche
            if event.key == pygame.K_DOWN : # si la touche est la fleche droite
                player.sens = "desc" # on déplace le vaisseau de 1 pixel sur
        else: player.sens = ""
############
